...
Pure read; no writes. Other read providers (memory, git, gh, ...) will
be added in later phases when concrete need surfaces — for now, the
...
def resume_brief(project: str, vault: Optional[VaultProvider] = None) -> str:
